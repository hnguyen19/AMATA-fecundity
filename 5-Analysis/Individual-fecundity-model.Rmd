...
#fecundity18 <- read_csv(here("2_Data/Clean/fecundity_18.csv"))
...
#f_biom_rot_ct <- contrast(regrid(f_biom_grid_rot_emm),"pairwise", type = "response", infer = c(TRUE,TRUE))
#across rotation
#f_biom_rot_ct <- contrast(f_biom_grid_rot_emm,"pairwise", type = "response", infer = c(TRUE,TRUE)) %>% print(export = TRUE)
...
f_biom_crop <- emmeans(f_biom_grid_crop , ~ Crop | Corn_weed_management, infer = c(FALSE,TRUE),  type = "response") 
f_biom_crop_ct <- contrast(f_biom_crop , "pairwise", type = "response", infer = c(FALSE,TRUE)) %>% print(export = TRUE)

## within rotation means  #herb effect was NS
f_biom_corn <-  emmeans(biomass.gls, ~ Crop_ID | Corn_weed_management, infer = c(FALSE,TRUE),  type = "response", at = list(Crop_ID = c("C2", "C3", "C4")))
f_biom_corn_ct <- contrast(f_biom_corn, "pairwise", type = "response", infer = c(FALSE,TRUE)) %>% print(export = TRUE)

f_biom_soy <- emmeans(biomass.gls, c("Crop_ID", "Corn_weed_management"), infer = c(FALSE,TRUE),  type = "response", at = list(Crop_ID = c("S2", "S3", "S4"))) 

f_biom_soy_ct <- contrast(f_biom_soy, by = "Corn_weed_management" ,"pairwise", type = "response", infer = c(FALSE,TRUE)) %>% print(export = TRUE)

f_biom_oat <- emmeans(biomass.gls, ~ Crop_ID| Corn_weed_management, infer = c(FALSE,TRUE),  type = "response", at = list(Crop_ID = c("O3", "O4")))

f_biom_oat_ct <- contrast(f_biom_oat, "pairwise", type = "response", infer = c(FALSE,TRUE)) %>% print(export = TRUE)
...
f_seeds_rot_ct <- contrast(regrid(f_seeds_grid_rot_emm),"pairwise", type = "response", infer = c(FALSE,TRUE))

#across rotation
f_seeds_rot_ct <- contrast(f_seeds_grid_rot_emm,"pairwise", type = "response", infer = c(FALSE,TRUE)) %>% print(export = TRUE)
Crop <- factor(c("corn", "soybean", "corn", "soybean", "oat", "corn", "soybean", "oat", "alfalfa"),
                     levels = c( "soybean", "corn",  "oat", "alfalfa"))
...
f_seeds_corn <-  emmeans(seeds.gls, ~ Crop_ID | Corn_weed_management, infer = c(FALSE,TRUE),  type = "response", at = list(Crop_ID = c( "C2", "C3", "C4")))
f_seeds_corn_ct <- contrast(f_seeds_corn, "pairwise", type = "response", infer = c(FALSE,TRUE)) %>% print(export = TRUE)

f_seeds_soy <- emmeans(seeds.gls, c("Crop_ID", "Corn_weed_management"), infer = c(FALSE,TRUE),  type = "response", at = list(Crop_ID = c("S2", "S3", "S4"))) 

f_seeds_soy_ct <- contrast(f_seeds_soy, by = "Corn_weed_management" ,"pairwise", type = "response", infer = c(FALSE,TRUE)) %>% print(export = TRUE)

f_seeds_oat <- emmeans(seeds.gls, ~ Crop_ID| Corn_weed_management, infer = c(FALSE,TRUE),  type = "response", at = list(Crop_ID = c("O3", "O4")))

f_seeds_oat_ct <- contrast(f_seeds_oat , "pairwise", type = "response", infer = c(FALSE,TRUE)) %>% print(export = TRUE)


# crop crontrast, averaged over rotations
f_seeds_crop <- emmeans(f_seeds_grid_crop , ~ Crop | Corn_weed_management, infer = c(FALSE,TRUE),  type = "response") 
f_seeds_crop_ct <- contrast(f_seeds_crop , "pairwise", type = "response", infer = c(FALSE,TRUE)) %>% print(export = TRUE)
