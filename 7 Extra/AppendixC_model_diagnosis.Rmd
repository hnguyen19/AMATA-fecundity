...
pop_biom18_2 <- lm(log(g_m_sq + 0.00025) ~ Block + Crop_ID +
                     Corn_weed_management + Crop_ID:Corn_weed_management, 
                   data = amata18)
resid_panel(pop_biom18_2) 
```
...
pop_biom19_2 <- lm(log(g_m_sq + 0.002) ~ Block + Crop_ID + 
                     Corn_weed_management + Crop_ID:Corn_weed_management,
                   data = amata19)
...
pop_dens18_3 <- lm(log(plant_m_sq + 0.025) ~ Block + Crop_ID +
                     Corn_weed_management + Crop_ID:Corn_weed_management, 
                   data = amata18)

resid_panel(pop_dens18_3) 
```
...
pop_dens19_3 <- lm(log(plant_m_sq + 0.025) ~ Block + Crop_ID +
                     Corn_weed_management + Crop_ID:Corn_weed_management,
                   data = amata19)

resid_panel(pop_dens19_3) 
...
sexed18.glm <- glm(cbind(Female, Male) ~ Block + Crop_ID + 
                     Corn_weed_management + Crop_ID:Corn_weed_management,
...
glm.diag.plots(sexr18_biom_glm3 )
...
### 18-mean full compound symmetry mod
