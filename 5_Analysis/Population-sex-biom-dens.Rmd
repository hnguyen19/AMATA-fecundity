...
```{r, include=FALSE}
amata18 <- read_csv("../2 Data/Clean data/AMATA_18_clean.csv",
...
amata19 <- read_csv("../2 Data/Clean data/AMATA_19_clean.csv",
                    col_types = cols(Plot = col_factor(), 
                                     Block = col_factor(), 
                                     Crop = col_factor(),
                                     Crop_ID = col_factor(),
...
grid.arrange(bp18, bp19, dp18, dp19, nrow = 2) # use gridExtra package 
```  
...
#  Crop phase effects: Calculate marginal means by crop species within each rotation followed by contrast (corn weed management effect was NS)
...
```{r, include=FALSE}
## Imputed 2019 sex ratio with m = 24 iterations.
