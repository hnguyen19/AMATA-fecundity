...
# .jpg can't be saved so .png will have to be converted to .jpg for manuscript submission
...
```{r, echo=FALSE}
# 2019 sexed data with missing information from all the soybean plots due to very high control efficacy
...
```{r, include=F}
# to improve aesthetics of the ggplot2 and emmeans::plot products
